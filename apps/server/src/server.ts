...
const ReactorLayerLive = Layer.empty.pipe(
  // First in the pipe, so every layer below provides to it: the bootstrap
  // needs the deletion reactor's drain fence as well as git, terminals and
  // the setup script runner.
